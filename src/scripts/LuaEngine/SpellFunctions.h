...
LuaSpellEntry luaSpellVars[] =
{
    ...
    { "SpellVisual_1", 0, offsetof(SpellEntry, SpellVisual[0]) },
    { "SpellVisual_2", 0, offsetof(SpellEntry, SpellVisual[1]) },
    ...
    { "DiminishStatus", 0, offsetof(SpellEntry, custom_DiminishStatus) },
    { "proc_interval", 0, offsetof(SpellEntry, custom_proc_interval) },
    { "BGR_one_buff_on_target", 0, offsetof(SpellEntry, custom_BGR_one_buff_on_target) },
    { "BGR_one_buff_from_caster_on_self", 0, offsetof(SpellEntry, custom_BGR_one_buff_from_caster_on_self) },
    ...
    { "spell_coef_flags", 0, offsetof(SpellEntry, custom_spell_coef_flags) },
    { "base_range_or_radius_sqr", 3, offsetof(SpellEntry, custom_base_range_or_radius_sqr) },
    ...
    { "self_cast_only", 2, offsetof(SpellEntry, custom_self_cast_only) },
    { "apply_on_shapeshift_change", 2, offsetof(SpellEntry, custom_apply_on_shapeshift_change) },
    { "always_apply", 2, offsetof(SpellEntry, custom_always_apply) },
    { "is_melee_spell", 2, offsetof(SpellEntry, custom_is_melee_spell) },
    { "is_ranged_spell", 2, offsetof(SpellEntry, custom_is_ranged_spell) },
    { "SchoolMask", 0, offsetof(SpellEntry, custom_SchoolMask) },
    { NULL, 0, 0 },
};
